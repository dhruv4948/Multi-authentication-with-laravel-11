    ...
    <div class="container">
        ...
        <div class="card border-0 shadow my-5">
            <div class="card-header bg-light">
                <h3 class="h5 pt-2">Team Leaders</h3>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($team as $te)
                            <tr>
                                ...
                                <td>{{ $te->email }}</td>
                                <td>
                                    <a href="{{route('teamLeader.demote', $te->id)}}"
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    @foreach ($leader as $li)
                                        <li>
                                            <form action="{{ route('update.teamleader', $employee->id) }}" method="POST"
                                                style="display: inline;">
                                                @csrf
                                                <input type="hidden" name="team_leader_id" value="{{ $li->id }}">
                                                <button type="submit" class="dropdown-item">{{ $li->name }}</button>
                                            </form>
                                        </li>
                                    @endforeach
                                </ul>
