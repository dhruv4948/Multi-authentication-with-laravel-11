    ...
    <div class="container">
        ...
        <div class="card border-0 shadow my-5">
            <div class="card-header bg-light">
                <h3 class="h5 pt-2">Details</h3>
            </div>
            <div class="card-body">
            <div class="container">
        
        <p><strong>Stored Path:</strong> {{ $err->stored_path }}</p>
        <p><strong>Selected table:</strong> {{ $err->table_type }}</p>
        ...
        @endif
        <a href="{{route('load.excel')}}" class="btn btn-primary">Back</a>
    </div>
